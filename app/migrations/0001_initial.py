    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_AssistantTeacher', models.BooleanField()),
                ('is_RegularTeacher', models.BooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classs', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.class')),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.school')),
            ],
            options={
                'unique_together': {('school', 'classs')},
            },
        ),
    ]
